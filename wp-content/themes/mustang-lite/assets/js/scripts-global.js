...
jQuery( function() {
	...
	jQuery(document).on('ready', function(){
		jQuery(document).on('click', '#mobile-nav', function(){
			if (jQuery('#nav-main').css('left') == '0px'){
				jQuery('#nav-main').css('left','-500px');
				jQuery('#nav-main').css('top','0');
				jQuery('#content-section').css('margin-left','0');

			}else{
				jQuery('#nav-main').css('left',0);
				jQuery('#nav-main').css('top','96px');
				jQuery('#content-section').css('margin-left', jQuery('#nav-main').css('width'));
			}
		});
	});
